...
export default Comment = ({ userID, comment, setPost, post }) => {
    ...
    <>
      ...
      <div className="SingleComment">
          ...
          <img
            src={
              comment.user_id.profilePic
                ? `http://localhost:5000/images/${comment.user_id.profilePic}`
                : "http://localhost:5000/images/DAIICT_LOGO.png"
            }
        ...
        <div className="bottomSection">
          <p className="commentText">{comment.cmt_text}</p>
          <div>
